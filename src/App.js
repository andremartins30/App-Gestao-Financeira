...
const App = () => {
    ...
    const handleAdd = (transaction) => {
        const mewArrayTransactions = [...transactionsList, transaction];

        setTransactionsList(mewArrayTransactions)

        localStorage.setItem("transactions", JSON.stringify(mewArrayTransactions));
    }
